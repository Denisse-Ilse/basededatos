...
-- Versión en español del esquema de empresa
-- (Empleado - Departamento - Ubicacion - Proyecto - Trabaja_en - Dependiente)
-- =========================================================
...
CREATE TABLE Departamento (
    ...
    GerenteSSN         CHAR(11) UNIQUE,   -- relación 1:1 con Empleado
    FechaInicio        DATE
);
